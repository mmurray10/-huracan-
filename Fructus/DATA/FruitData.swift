...
let fruitsData: [Fruit] = [
    Fruit(
        title: "Blueberry",
        headling: "Blueberries are sweet, nutritious and wildly popular fruit all over the world.",
        image: "blueberry",
      ...
      Fruit(
        title: "Strawberry",
        headling: "Widely appreciated for its characteristic aroma,  red color, juicy texture, and sweetness.",
        image: "strawberry",
      ...
      Fruit(
        title: "Lemon",
        headling: "There's no doubt lemons are delicious, but does adding them to water make you healthier?",
        image: "lemon",
      ...
      Fruit(
        title: "Plum",
        headling: "Plums are a very nutritious fruit. An excellent source of vitamins, minerals, fiber and antioxidants.",
        image: "plum",
      ...
      Fruit(
        title: "Lime",
        headling: "Sour, round, and bright green citrus fruits. Limes are high in vitamin C, antioxidants, and other nutrients.",
        image: "lime",
      ...
      Fruit(
        title: "Pomegranate",
        headling: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "pomegranate",
      ...
      Fruit(
        title: "Apple",
        headling: "Apples are one of the most popular, and exceptionally healthy fruit for good reason.",
        image: "apple",
